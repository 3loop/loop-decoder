...
const AA = function transformEvent(event) {
...
const BLUR_V3 = function transformEvent(event) {
...
const AAVE_V2 = function transformEvent(event) {
  const methodName = event.methodCall.name
  let action = ''
